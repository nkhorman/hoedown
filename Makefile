...
uninstall:
	rm -f $(DESTDIR)$(BINDIR)/hoedown $(DESTDIR)$(BINDIR)/smartypants
	rm -f $(DESTDIR)$(LIBDIR)/libhoedown.a $(DESTDIR)$(LIBDIR)/libhoedown.so.3 $(DESTDIR)$(LIBDIR)/libhoedown.so
	rm -rf $(DESTDIR)$(INCLUDEDIR)/hoedown
